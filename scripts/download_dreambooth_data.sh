...
cp /content/drive/MyDrive/TechConda/v1-5-pruned.ckpt /content/TeCH/data/dreambooth_data/v1-5-pruned.ckpt


# ECON
echo -e "\nDownloading dreambooth background images and regularization images..."
cp /content/drive/MyDrive/TechConda/dreambooth_data.zip /content/TeCH/data/dreambooth_data/dreambooth_data.zip
